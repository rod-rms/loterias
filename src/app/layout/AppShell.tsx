      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-3 px-4 py-3">
          <Link to="/" className="flex flex-col leading-tight">
            ...
            <span className="text-xs text-slate-500">Carteiras e estratégias auditáveis</span>
          </Link>
          <GameSwitcher />
        ...
        <div className="mx-auto flex max-w-6xl flex-wrap gap-2 px-4 pb-2">
          <DataFreshnessBadge latestContest={latestContest.lotofacil} />
          <DataFreshnessBadge latestContest={latestContest.megasena} />
        </div>
      </header>
