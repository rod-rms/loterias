import { generateMegaSenaPortfolioRequest } from "../strategies/adapters";
import type { GeneratePortfolioRequest, WorkerResponseMessage } from "../../../shared/types";

type Result = Awaited<ReturnType<typeof generateMegaSenaPortfolioRequest>>;
...
workerScope.onmessage = async (event) => {
  try {
    ...
    const result = await generateMegaSenaPortfolioRequest(event.data);
